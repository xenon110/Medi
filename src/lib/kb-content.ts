...
export const KNOWLEDGE_BASE: KnowledgeBaseArticle[] = [
  ...
  { slug: 'athletes-foot', title: "Athlete's Foot", subtitle: "Understanding athlete's foot.", images: ['kb-infections-1', 'kb-infections-2', 'kb-infections-3'], overview: 'A common fungal infection that affects the feet, causing itching, scaling, and redness.', symptoms: ['Itchy, scaly rash, usually between the toes.'], causes: 'Fungus that thrives in warm, moist environments.', homeRemedies: ['Keep feet clean and dry, use OTC antifungal powders.'], medicalRecommendation: 'Prescription-strength antifungal creams or oral medications may be needed.', disclaimer: defaultDisclaimer, },
  { slug: 'cellulitis', title: 'Cellulitis', subtitle: 'Understanding cellulitis.', images: ['kb-infections-1', 'kb-infections-2', 'kb-infections-3'], overview: 'A serious bacterial skin infection that appears as a swollen, red area of skin that feels hot and tender.', symptoms: ['Red, swollen, hot, and painful skin area.'], causes: 'Bacteria entering a break in the skin.', homeRemedies: ['None. This requires medical attention.'], medicalRecommendation: 'Seek immediate medical care. Oral or intravenous antibiotics are required.', disclaimer: defaultDisclaimer, },
  { slug: 'cold-sores', title: 'Cold Sores', subtitle: 'Understanding cold sores.', images: ['kb-infections-1', 'kb-infections-2', 'kb-infections-3'], overview: 'Painful blisters on or near the lips caused by the herpes simplex virus (HSV-1).', symptoms: ['Tingling or burning, followed by small fluid-filled blisters.'], causes: 'Herpes simplex virus, which is highly contagious.', homeRemedies: ['OTC creams can shorten the duration.'], medicalRecommendation: 'A doctor can prescribe antiviral medications to manage outbreaks.', disclaimer: defaultDisclaimer, },
  { slug: 'heat-rash', title: 'Heat Rash', subtitle: 'Understanding heat rash.', images: ['kb-rashes-1', 'kb-rashes-2', 'kb-rashes-3'], overview: 'Also known as prickly heat, it occurs when sweat is trapped in the skin, causing a rash of small red bumps.', symptoms: ['Clusters of small, red, itchy bumps.'], causes: 'Blocked sweat ducts in hot, humid weather.', homeRemedies: ['Move to a cooler, less humid environment. Keep the skin cool and dry.'], medicalRecommendation: 'Usually resolves on its own. Severe forms may need topical treatments.', disclaimer: defaultDisclaimer, },
  { slug: 'impetigo', title: 'Impetigo', subtitle: 'Understanding impetigo.', images: ['kb-infections-1', 'kb-infections-2', 'kb-infections-3'], overview: 'A highly contagious bacterial skin infection that causes red sores that can break open, ooze fluid, and develop a yellow-brown crust.', symptoms: ['Red sores that form a honey-colored crust.'], causes: 'Staphylococcus or Streptococcus bacteria.', homeRemedies: ['Keep clean, but medical treatment is necessary.'], medicalRecommendation: 'Requires topical or oral antibiotics to clear the infection and prevent spread.', disclaimer: defaultDisclaimer, },
  { slug: 'ringworm', title: 'Ringworm', subtitle: 'Understanding ringworm.', images: ['kb-infections-1', 'kb-infections-2', 'kb-infections-3'], overview: 'A common fungal infection of the skin, characterized by a circular rash.', symptoms: ['A ring-shaped rash that is itchy, red, and scaly.'], causes: 'A fungus, not a worm. It is contagious.', homeRemedies: ['Over-the-counter antifungal creams.'], medicalRecommendation: 'If OTC treatments don\'t work, a doctor can prescribe stronger medications.', disclaimer: defaultDisclaimer, },
  { slug: 'seborrhoeic-dermatitis', title: 'Seborrhoeic Dermatitis', subtitle: 'Understanding seborrhoeic dermatitis.', images: ['kb-eczema-1', 'kb-eczema-2', 'kb-eczema-3'], overview: 'A common skin condition that mainly affects your scalp, causing scaly patches, red skin, and stubborn dandruff.', symptoms: ['Dandruff, greasy scales, and itchy patches on the scalp, face, or chest.'], causes: 'May be related to a fungus called malassezia, hormones, or an inflammatory response.', homeRemedies: ['Medicated shampoos containing ketoconazole, selenium sulfide, or zinc pyrithione.'], medicalRecommendation: 'A dermatologist can prescribe stronger shampoos, creams, or lotions.', disclaimer: defaultDisclaimer, },
